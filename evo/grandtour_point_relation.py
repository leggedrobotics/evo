...
def run_ate(args):  
    ...
    traj_reference = file_interface.read_tum_trajectory_file(base_path + "prism_position_posestamped.tum")
    ...
    if test_name == "zed2i":
        # ZED2I
        traj_estimated = file_interface.read_tum_trajectory_file(base_path + "gt_box_zed2i_zed_node_odom.tum")

    if test_name == "open3d_slam":
        # Open3d SLAM
        traj_estimated = file_interface.read_tum_trajectory_file(base_path + "slam_poses.txt")
